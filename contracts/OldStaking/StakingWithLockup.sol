...
contract StakingWithLockup is Ownable, ERC20NonTransferrable {
    // lib
    ...
    constructor(
        ...
        uint256[] memory rewardsForDuration,
        uint256[] memory rewardCapsForDuration,
        uint256[] memory rewardDurations,
        string memory name,
        string memory symbol) ERC20NonTransferrable(name, symbol) {
